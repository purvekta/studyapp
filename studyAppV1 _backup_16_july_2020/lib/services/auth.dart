...
//auth change user stream
  ...
  Future registerwithEmailAndPassword(String email, String password,String nickName,var mobNo) async {
    try {
      ...
      await UserManagement(uid: user.uid).updateUserDData(email,userUpdateInfo.displayName,userUpdateInfo.photoUrl,usermobNo );
