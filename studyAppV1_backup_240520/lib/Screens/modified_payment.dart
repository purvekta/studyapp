...
class Modi_PaymentDetail extends StatefulWidget {
  var totalamount;
  Modi_PaymentDetail({this.totalamount});
 
  @override
  Modi_PaymentDetailState createState() => Modi_PaymentDetailState();
}

class Modi_PaymentDetailState extends State<Modi_PaymentDetail> {
