...
class FirebaseDatabaseCourseUtil {
  ...
  static final FirebaseDatabaseCourseUtil _instance =
      new FirebaseDatabaseCourseUtil.internal();

  FirebaseDatabaseCourseUtil.internal();

  factory FirebaseDatabaseCourseUtil() {
    return _instance;
  }
  ...
  void initState() {
    ...
    _userRef = database.reference().child('transdata');
    database
        .reference()
        .child('transdata')
        .once()
  ...
  addUser(TransRealData transRealData) async {
