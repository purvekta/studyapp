          ...
          showDialog(
              ...
              builder: (context) {
                var _registredEmailIDController;
                                return AlertDialog(
                                  title: Text("Enter your Registred Email Id"),
                                  content: Column(
                                    mainAxisSize: MainAxisSize.min,
                                    children: <Widget>[
                                      TextField(
                                        controller: _registredEmailIDController,
                      ),
                    ],
                  ),
                  actions: <Widget>[
                    FlatButton(
                      ...
                      color: Colors.blue,
                      onPressed: () async {
                        final registredEmailId = _registredEmailIDController.text.trim();
                        await _auth.forgetPassWord(registredEmailId);
                        //Navigator. pop();
                                              },
                    )
                  ],
