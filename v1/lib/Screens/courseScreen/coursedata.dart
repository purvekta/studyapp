...
import 'package:studyapp/Screens/Widgets/customshapclipper.dart';
    ...
    return Scaffold(
      ...
      children: <Widget>[
        ...
        Container(
          height: 500,
          child: FutureBuilder(
              future: DefaultAssetBundle.of(context).loadString(courseUrl),
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return Card(
                      child: ListTile(
                        ...
                        trailing: (mydata[index]['islocked'])
