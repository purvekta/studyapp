...
//import 'package:studyapp/Screens/onemorecourseupdated.dart';
                    ...
                    child: GestureDetector(
                      ...
                      onTap: () {
                         //Navigator.of(context).pushNamed('/sub1',arguments: DetailsScreen(courseName: courseName,coursePrice:'2500'));
                           Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => CourseData(courseName: 'Biology',coursePrice:'2500' )),
                              );
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                     ...
                     //   Navigator.of(context).pushNamed('/sub2',arguments: DetailsScreen(courseName: 'Physics',coursePrice:'2500'));
                      ...
                      Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => CourseData(courseName: 'Physics',coursePrice:'2500' )),
                              );
                      },
                    ),
                  ),
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: GestureDetector(
                      child: Text('Maths'),
                      onTap: () {
                        Navigator.of(context).pushNamed('/sub3',arguments: DetailsScreen(courseName: 'Physics',coursePrice:'2500'));
                        // Navigator.of(context).pushNamed('/MyCourse');
                      },
                    ),
                  ),
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                      child: Text('biology'),
                      onTap: () {
                        Navigator.of(context).pushNamed('/sub1',arguments: DetailsScreen(courseName: 'chemistry',coursePrice:'2500'));
                        //Navigator.of(context).pushNamed('/MyCourse');
                      },
                    ),
                  ),
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: GestureDetector(
                     ...
                     Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => CourseData(courseName: 'JEE',coursePrice:'2500' )),
                              );
                      },
                    ),
                  ),
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                      ...
                      onTap: () {
                        Navigator.of(context).pushNamed('/sub4',arguments: DetailsScreen(courseName: 'chemistry',coursePrice:'2500'));
                        //Navigator.of(context).pushNamed('/MyCourse');
                      },
                    ),
                  ),
