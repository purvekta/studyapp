...
class RazorPayDetails extends StatefulWidget {
  @override
  _RazorPayDetailsState createState() => _RazorPayDetailsState();
}

class _RazorPayDetailsState extends State<RazorPayDetails> {
  @override
  Widget build(BuildContext context) {
   ...
   startPayment() async {
    ...
    options.putIfAbsent("api_key", () => "rzp_test_Of6iZlY1XSVoIF");
    //Notes -- OPTIONAL
