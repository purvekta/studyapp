/*
this is code related to mycourse screen in which it fetches data from the cloudfirestore and list in my course list 
it only fetch course id and payment id nothing else
import 'dart:convert';
...
class MycourseScreenNew extends StatefulWidget {
  ...
  //     this.vLink});
  @override
  _MycourseScreenNewState createState() => _MycourseScreenNewState();
}

class _MycourseScreenNewState extends State<MycourseScreenNew> {
              ...
              child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      // Container(
                      //   child: listPaidCourses(),
                      // ),
                      Container(
                          height: 400,
                          child: FutureBuilder(
                              //future: listPaidCourses(),
                                  ...
                                  itemBuilder: (context, i) {
                                    return Card(
                                      ...
                                      child: new ListTile(
                                        ...
                                        //           image: NetworkImage(transData
                                        //               .documents[i]
                                        //               .data['courseimg']))),
                                        // ),
                                        title: Text(transData
                                            .documents[i].data['paymentid']),
                                        subtitle: Text(transData
                                            .documents[i].data['courseid']),
                                      ),
                                    );
                                  });
                            } else {
